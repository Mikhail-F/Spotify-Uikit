...
class NewReleaseCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        let albumLabelSize = albumNameLabel.sizeThatFits(CGSize(width: contentView.width-imageSize-10, height: contentView.heigth-10))
    ...
    func configure(viewModel: NewReleasesCellViewModel) {
        ...
        albumNameLabel.clipsToBounds = true
